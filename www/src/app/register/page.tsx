...
const CAPTCHA_URL = 'http://www.sparrowzoo.com/validate-code?t=';
export default class Page extends React.Component {
    ...
    constructor() {
        ...
        // 初始化 state
        this.state = {
            captchaUrl: CAPTCHA_URL + Math.random()
        }
    }
            ...
            <div className="grid grid-cols-1 gap-1 ">
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-row text-center h-auto justify-center items-center">
                        <img className="w-16 inline-block cursor-pointer" onClick={this.getCaptcha} src={this.state.captchaUrl}/><a
